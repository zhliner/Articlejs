...
代码内的高亮着色采用 `<b>` 元素封装，由 `role` 定义高亮所属的类型（简写）。所有 `<b>` 元素只会处于同一层级（`<code>` 直接子元素），不存在嵌套。
...
b[role=tag]     /* tag-name */
b[role=slr]     /* selector */
b[role=atn]     /* attribute-name */
b[role=atv]     /* attribute-value */
b[role=fun]     /* function-work */
b[role=typ]     /* data-type */
b[role=imp]     /* important */
b[role=doc]     /* <!DOCTYPE...> */
b[role=cdt]     /* <![CDATA[...]]> */
b[role=rex]     /* js-RegExp */
b[role=non]     /* invalid */
```
...
```html
<ol role="codelist" role="codelist">
