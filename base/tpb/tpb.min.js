...
let be=null;function we(e,n,a,r,i){if(t.isFunction(a))return M(e,n,a,r);C(n,a,r,i,e)}function ve(e,n,a,r,i){return t.isFunction(a)?M(e,n,a,r):t.isArray(r)?C(n,a,r,i,e):void function(e,n,a,r){let i=a?$:E;t.assign(k(e.split("."),r),n||{},i)}(n,a,r,e)}function xe(t,e,n,a){M(t,e,new Proxy({},{get:(t,e)=>j(n(e),a)}))}function Ae(t,e,n,a=[]){let r=t[e];if(null!=r)throw new Error(`By[${e}] is already exist.`);t[e]=r={};let i=new ye(n.control,n.model,n.view);r.run=i.run.bind(i),a.forEach((t=>r[t]=i.call.bind(i,t)))}function Ee(t=Gt,e=Zt){return new ht({on:t,by:e,update:ge.Update,next:ge.Next},S)}r&&(window.Update=ge.Update,window.Next=ge.Next,window.namedTpls=function(e,n){let a=new Map;t.isArray(e)||(e=[e]);e.forEach((t=>a.set(t,null))),f.clear(),Promise.all(e.map((e=>f.node(`${_.tpldir}/${e}`).then((e=>t.find("[tpl-name]",e).map((e=>t.attr(e,"tpl-name"))))).then((t=>a.set(e,n?function(t){let e;return t.sort().map((t=>{let n=t===e?`[__REPEATED__]: ${t}`:t;return e=t,n}))}(t):t)))))).then((()=>function(t){let e={};for(const[n,a]of t)e[n]=a;window.console.info(JSON.stringify(e,null,"\t"))}(a)))},window.DataStore=u);const $e={Init:function(t,e){be=h(new A(Ee(t,e),_.tpldir))},build:function(t,e,n){return(n=n||be).config(e).then((()=>n.build(t)))},obtBuild:function(t,e,n={}){return Ee(n.on,n.by).build(t,e)}};export{Zt as BaseBy,Gt as BaseOn,$e as Tpb,Ae as cmvApp,we as customGetter,Ee as obtBuilder,ve as processExtend,xe as processProxy};
